...
| `backend/src/services/audio_filter.py` | Builds corpus search and filter queries (word, language, speaker, date, status) for MVP v2 dashboard features. | 30% | 88% | [CI Run](https://github.com/SWP-Team20/Bilingual-speech-recognition/actions/runs/28302441842/job/83853012352) |
...
| `backend/src/dependencies.py` | JWT validation and role checks for admin and editor routes (MVP v2). | 30% | — | [CI Run](https://github.com/SWP-Team20/Bilingual-speech-recognition/actions/runs/28302441842/job/83853012352) |

**Global line coverage (`backend/src`):** 50% from the full `pytest scripts/ --cov=backend/src` suite (68 tests with Postgres in CI).
...
| :--- | :--- | :--- | :--- | :--- |
| Unit tests | Critical product logic (`build_sentences`, corpus filters, speaker matching, transcript edit, `text_filter`, `lang_tag`, auth helpers) | `pytest scripts/Unit/ -m unit` | Passing (55 tests) | [CI Run](https://github.com/SWP-Team20/Bilingual-speech-recognition/actions/runs/28302441842/job/83853012352) |
...
| Automated QRTs | QR-001 unauthorized access (`test_security.py`); QR-004 role-based authorization (`test_authorization.py`) | `pytest scripts/QualityRequirements/ -m qrt` | Passing (9 tests) | [CI Run](https://github.com/SWP-Team20/Bilingual-speech-recognition/actions/runs/28302441842/job/83853012352) |
...
| Combined backend suite | All pytest tests under `scripts/` with line coverage | `pytest scripts/ --cov=backend/src` | Passing (68 tests); 50% global line coverage | [CI Run](https://github.com/SWP-Team20/Bilingual-speech-recognition/actions/runs/28302441842/job/83853012352) |
...
| MVP v2 dashboard filters and admin panel UX | Manual verification of corpus filters, search, storage size display, and admin user management in the deployed product. | Passed (Sprint 3 UAT / screenshots in week report) | Sprint 3 PBIs (US-019, US-022–US-024, #161, #164) |
